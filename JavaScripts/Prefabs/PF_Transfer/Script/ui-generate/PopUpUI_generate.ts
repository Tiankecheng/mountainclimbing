 ...
 * @LastEditors  : 田可成
 * @LastEditTime : 2023-01-03 13:16:38
 * @FilePath     : \ilovethemountains\Prefabs\PF_Transfer\Script\ui-generate\PopUpUI_generate.ts
 * @Description  : 
 */
 ...
 * AUTHOR: 维纟丶酱
 * UI: Prefabs/PF_Transfer/UI/PopUpUI.ui
 * TIME: 2022.12.29-12.37.59
 */



@UIBind('Prefabs/PF_Transfer/UI/PopUpUI.ui')
export default class PopUpUI_Generate extends mw.UIScript {
	...
	protected initButtons() {
		...
		let id = setInterval(() => {
			...
			if (this.mTransfer.text != "avd_text_1") {
				clearInterval(id);
			}
		}, 30);
