 ...
 @UIBind('UI/guideModule/CameraGm.ui')
 export default class CameraGm_Generate extends mw.UIScript {
     @UIWidgetBind('MWCanvas_2147482460/mText')
    public mText: mw.TextBlock=undefined;
    @UIWidgetBind('MWCanvas_2147482460/mX')
    public mX: mw.InputBox=undefined;
    @UIWidgetBind('MWCanvas_2147482460/mY')
    public mY: mw.InputBox=undefined;
    @UIWidgetBind('MWCanvas_2147482460/mZ')
    public mZ: mw.InputBox=undefined;
