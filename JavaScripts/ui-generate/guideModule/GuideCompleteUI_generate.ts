 ...
 @UIBind('UI/guideModule/GuideCompleteUI.ui')
 export default class GuideCompleteUI_Generate extends mw.UIScript {
     @UIWidgetBind('MWCanvas_2147482460/mTips')
    public mTips: mw.TextBlock=undefined;
