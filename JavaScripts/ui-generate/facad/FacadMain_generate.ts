 ...
 @UIBind('UI/facad/FacadMain.ui')
 export default class FacadMain_Generate extends mw.UIScript {
     @UIWidgetBind('MWCanvas_2147482460/intervalLine_down')
    ...
    @UIWidgetBind('MWCanvas_2147482460/MWCanvas_4/MWCanvas_2/MWCanvas_1/intervalLine_up')
    ...
    public mGoldImg: mw.Image=undefined;
     ...
     protected initLanguage(){
         ...
         this.setLanguage(this.uiWidgetBase.findChildByPath("MWCanvas_2147482460/MWCanvas_4/MWCanvas_2/MWCanvas_1/TextBtn1") as mw.TextBlock);
	
         this.setLanguage(this.uiWidgetBase.findChildByPath("MWCanvas_2147482460/MWCanvas_4/MWCanvas_2/MWCanvas_1/TextBtn2") as mw.TextBlock);
	
         this.setLanguage(this.uiWidgetBase.findChildByPath("MWCanvas_2147482460/MWCanvas_4/MWCanvas_2/MWCanvas_1/TextBtn3") as mw.TextBlock);
	
         this.setLanguage(this.uiWidgetBase.findChildByPath("MWCanvas_2147482460/MWCanvas_4/MWCanvas_2/MWCanvas_1/TextBtn4") as mw.TextBlock);
	
         this.setLanguage(this.uiWidgetBase.findChildByPath("MWCanvas_2147482460/MWCanvas_4/MWCanvas_2/MWCanvas_1/TextBtn5") as mw.TextBlock);
	
         this.setLanguage(this.uiWidgetBase.findChildByPath("MWCanvas_2147482460/MWCanvas_4/MWCanvas_2/MWCanvas_1/TextBtn6") as mw.TextBlock);
	
         this.setLanguage(this.uiWidgetBase.findChildByPath("MWCanvas_2147482460/MWCanvas_4/MWCanvas_2/MWCanvas_1/TextBtn7") as mw.TextBlock);
